...
var PgRecordReturnTypesPlugin = function PgRecordReturnTypesPlugin(builder) {
  builder.hook("init", (_, build) => {
    ...
    introspectionResultsByKind.procedure.forEach(proc => {
      ...
      newWithHooks(GraphQLObjectType, {
              ...
              addDataGenerator(parsedResolveInfoFragment => {
                ...
                return {
                  pgQuery: queryBuilder => {
                    queryBuilder.select(getSelectValueForFieldAndTypeAndModifier(fieldType, fieldContext, parsedResolveInfoFragment, sql.fragment`(${queryBuilder.getTableAlias()}.${sql.identifier( // According to https://www.postgresql.org/docs/10/static/sql-createfunction.html,
        ...
        __origin: `Adding record return type for ${describePgEntity(proc)}. You can rename the function's GraphQL field (and its dependent types) via a 'Smart Comment':\n\n  ${sqlCommentByAddingTags(proc, {
          name: "newNameHere"
...
exports.default = PgRecordReturnTypesPlugin;
